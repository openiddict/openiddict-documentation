...
As part of this process, native support for `Microsoft.Owin` was added to OpenIddict 3.0+ to allow using it in legacy ASP.NET 4.6.2 (and higher) applications,
