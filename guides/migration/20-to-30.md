...
```xml
<ItemGroup>
  <PackageReference Include="OpenIddict" Version="2.0.1" /> <!-- [!code remove] -->
  <PackageReference Include="OpenIddict.AspNetCore" Version="3.1.1" /> <!-- [!code add] -->

  <PackageReference Include="OpenIddict.EntityFrameworkCore" Version="2.0.1" /> <!-- [!code remove] -->
  <PackageReference Include="OpenIddict.EntityFrameworkCore" Version="3.1.1" /> <!-- [!code add] -->
</ItemGroup>
```
