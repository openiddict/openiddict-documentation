...
```xml
<ItemGroup>
  <PackageReference Include="OpenIddict.AspNetCore" Version="3.1.1" /> <!-- [!code remove] -->
  <PackageReference Include="OpenIddict.AspNetCore" Version="4.10.1" /> <!-- [!code add] -->

  <PackageReference Include="OpenIddict.EntityFrameworkCore" Version="3.1.1" /> <!-- [!code remove] -->
  <PackageReference Include="OpenIddict.EntityFrameworkCore" Version="4.10.1" /> <!-- [!code add] -->
</ItemGroup>
```
...
## Update your OpenIddict MongoDB authorizations (if applicable)
...
## Replace references to `Portable.BouncyCastle` by `BouncyCastle.Cryptography` (if applicable)
...
## Update your custom stores to use the updated signatures (if applicable)
