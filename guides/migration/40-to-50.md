...
```xml
<ItemGroup>
  <PackageReference Include="OpenIddict.AspNetCore" Version="4.10.1" /> <!-- [!code remove] -->
  <PackageReference Include="OpenIddict.AspNetCore" Version="5.8.0" /> <!-- [!code add] -->

  <PackageReference Include="OpenIddict.EntityFrameworkCore" Version="4.10.1" /> <!-- [!code remove] -->
  <PackageReference Include="OpenIddict.EntityFrameworkCore" Version="5.8.0" /> <!-- [!code add] -->
</ItemGroup>
```
...
await manager.CreateAsync(new OpenIddictApplicationDescriptor
{
    ...
    Type = ClientTypes.Confidential // [!code remove]
    ClientType = ClientTypes.Confidential // [!code add]
});
```
...
## Update your OpenIddict MongoDB applications (if applicable)
...
## Update your custom stores to implement the new APIs (if applicable)
